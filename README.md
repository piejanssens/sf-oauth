...
> ⚠️ For **development** purposes, you can generate a personal key pair and use it for multiple preview/dev SF instances.
> In this case use private.pem and public.pem, which can be generated by running `sf-oauth --newkeypair`
...
### Generate a key pair and corresponding X.509 certificate
